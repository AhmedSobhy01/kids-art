...
ActionType Input::GetUserAction() const
{
	...
	if (UI.InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_OUTLINE: return OUTLINE;
			case ITM_SELECT: return SELECT;
			case ITM_BORDER_WIDTH: return BORDER_WIDTH;
			case ITM_OUTLINE_COLOR: return OUTLINE_COLOR;
			case ITM_FILL_COLOR: return FILL_COLOR;
			case ITM_FILL: return FILL;
			case ITM_REMOVE: return REMOVE;
			case ITM_MOVE: return MOVE;
			case ITM_RESIZE: return RESIZE;
			case ITM_DRAG_MOVE: return DRAG_MOVE;
			case ITM_DRAG_RESIZE: return DRAG_RESIZE;
			...
			case ITM_OPEN: return OPEN_GRAPH;
	...
	else	//GUI is in PLAY mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			switch (ClickedItemOrder)
			{
				...
				case ITM_PICKBYSHAPE: return PICK_BY_SHAPE;
				case ITM_PICKBYCOLOR: return PICK_BY_COLOR;
				case ITM_PICKBYSHAPEANDCOLOR: return PICK_BY_SHAPE_COLOR;
